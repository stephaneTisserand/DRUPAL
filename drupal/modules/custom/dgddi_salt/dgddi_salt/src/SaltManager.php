...
class SaltManager
{
  ...
  public function __construct($apiCode, $apiPassword, $salt, $defaultURL) {
    ...
    /*$this->apiCode   = "ADMIN_API_RIGHTS";
    $this->apiPassword  = "I4m_the_AdmInIstr4t0r/ofR|ght";
    $this->salt         = "gd47gf564d";
    $this->defaultURL   = "http://val-bo1-api-rights.douane-gouv.tma/3.1/Teleservice";*/
