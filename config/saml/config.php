...
if (file_exists(__DIR__ . '/../drupal/settings.local.php')) {
    include __DIR__ . '/../drupal/settings.local.php';
}
...
$config = array(
     ...
     * syntaxes.
     */
    'store.sql.dsn'                 => 'pgsql:host=' . $databases['default']['default']['host'] . ';port=' . $databases['default']['default']['port'] . ';dbname=dgddi_cache_simplesaml',

    /*
     * The username and password to use when connecting to the database.
     */
    'store.sql.username' => $databases['default']['default']['username'],
    'store.sql.password' => $databases['default']['default']['password'],
